...
class Bip21URITest {
    ...
    fun `URI cannot be built if scheme is not present`() {
        ...
        assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri(uri)
        }
    }

    @Test
    fun `URI only has bitcoin address`() {
        val uri = org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd")
    ...
    fun `Schema is case insensitive`() {
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("BiTcOiN:1andreas3batLhQa2FawWjeyjCqyBzypd")
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("BITCOIN:1andreas3batLhQa2FawWjeyjCqyBzypd")
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("Bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd")
    }
    ...
    fun `URI has bech32 address in all caps`() {
        val uri = org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:BC1Q0XCQPZRKY6EFF2G52QDYE53XKK9JXKVRH6YHYW")
    ...
    fun `URI has parameters we don't know`() {
        val uri = org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=100&arg1=50&arg2=999&arg3=abc%20abc")
    ...
    fun `URI has extreme bitcoin amounts`() {
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=21000000")
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=21000000.0000000000000")
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=0.00000001")
        org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=000000000000.00000001")
    }

    @Test
    fun `Build URI using spaces in values of label message and other parameters`() {
        val uri = org.kotlinbitcointools.bip21.Bip21URI(
    ...
    fun `Can parse unified QRs`() {
        ...
        val uri = org.kotlinbitcointools.bip21.Bip21URI.fromUri(unifiedQr)
    ...
    fun `URI has duplicate parameters`() {
        val exception = assertFailsWith<InvalidURIException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=100&amount=50")
        }
    ...
    fun `URI doesn't use bitcoin scheme`() {
        val exception = assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("https://example.com")
        }
    ...
    fun `URI has no address`() {
        val exception = assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:")
        }
    ...
    fun `URI has a parameter missing an '=' sign`() {
        val exception = assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount100&arg1=50&arg2=999&arg3=abc%20abc")
        }
    ...
    fun `URI has invalid bitcoin amounts`() {
        val exception1 = assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=21000001")
        }
        val exception2 = assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=21000000.00000001")
        }
        val exception3 = assertFailsWith<IllegalArgumentException> {
            org.kotlinbitcointools.bip21.Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=0.000000001")
        }

...
class Bip21URITest {
    ...
    fun `URI only has bitcoin address`() {
        val uri = Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd")
    ...
    fun `URI has parameters we don't know`() {
        val uri = Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount=100&arg1=50&arg2=999&arg3=abc%20abc")
    ...
    fun `URI has a parameter missing an '=' sign`() {
        val exception = assertFailsWith<IllegalArgumentException> {
            Bip21URI.fromUri("bitcoin:1andreas3batLhQa2FawWjeyjCqyBzypd?amount100&arg1=50&arg2=999&arg3=abc%20abc")
        }

 ...
 */
public class Satoshi(public val sat: Long) {
    init {
    ...
    /**
     * Alternate constructor to build a [Satoshi] from a String.
     */
    ...
    public companion object {
        ...
        public fun fromBitcoin(amount: String): Satoshi {
            ...
            return Satoshi(sat = satoshis.toLong())
        }
    }
}

/** Build a [Satoshi] from a Long. */
public fun Long.satoshi(): Satoshi = Satoshi(this)

/** Build a [Satoshi] from a bitcoin amount in String format. */
public fun String.fromBitcoinAmountToSatoshi(): Satoshi = Satoshi.fromBitcoin(this)
